  ...
  const onFinish = async (values) => {
    if (values.country === "Uganda") {
      let newValues = {
        ...
        type: values.type,
        amount: (values.amount / exchangeData?.rates?.UGX).toFixed(2),
        amountCurr: (
            ...
            <div className="withdraw-main-1">
              <div className="withdraw-main-1-1">
                ...
                className="withdraw-form-item"
                  ...
                  <Input
                  className="withdraw-form-input"
                  placeholder={i18next.t("tncurr19")}
                  />
                </Item>{" "} */}
                  </>
                )}
            ...
            >
              {() => (
                <Button
                  ...
                  htmlType="submit"
                  disabled={
                    withdrawProfit < 50 || country === "Uganda"
                      ? amount / exchangeData?.rates["UGX"] > withdrawProfit
